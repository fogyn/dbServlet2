...
@WebServlet("/views/getNumCountryMinColPeople")
public class NumCountryMinPeople extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(num<=0){
            ...
            try(Connection connection = ConnectionUrl.createConnection();
                ...
                PreparedStatement statement = connection.prepareStatement("select namecountry, people from country ORDER by people ASC LIMIT ? ;");
            ){
